...
func New(db *sql.DB) *Service {
	return &Service{DB: db, Users: repository.Users{DB: db}, Sessions: repository.Sessions{DB: db}, Projects: repository.Projects{DB: db}, Corpora: repository.Corpora{DB: db}, Batches: repository.Batches{DB: db}, Tasks: repository.Tasks{DB: db}, Analyses: repository.Analyses{DB: db}, Audit: audit.Logger{DB: db}, Clock: clock.Real{}}
}
